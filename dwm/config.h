...
static const int barheight          = 30;       /* fixed bar height; matches the quickshell bar that covers it (0 = font-based) */
...
static const int focusfollowsmouse = 0; /* 0 = click-to-focus (macOS style), 1 = focus follows hover */
...
static const char *screenshotcmd[] = { "/bin/sh", "-c",
	...
	"notify-send -a Screenshot 'Screenshot captured' \"$f\"", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	/* macOS-style: Cmd+Space = Spotlight, Cmd+Return = terminal, Cmd+Q/W = close */
